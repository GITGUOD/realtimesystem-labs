    ...
    public void run() {
        try {
               ...
               //Börja tvätta
                ...
                System.out.println("SETTING WATER");
                water.send(new WashingMessage(this, WATER_FILL));
                WashingMessage ackForFillingWater2 = receive();
                System.out.println("Washing program test got" + ackForFillingWater2);

                //Temperaturen 40grader
                System.out.println("SETTING TEMP 60...");
                temp.send(new WashingMessage(this, TEMP_SET_60));
                WashingMessage ackForSettingTemp60 = receive();
                System.out.println("SWashing program test got" + ackForSettingTemp60);
               ...
               //Börja tvätta
                ...
                System.out.println("setting TEMP_IDLE....");
                temp.send(new WashingMessage(this, TEMP_IDLE));
                WashingMessage ackForTempIdle2 = receive();
                System.out.println("washing program test got" + ackForTempIdle2);

                System.out.println("SETTING WATER_DRAIN.......");
                water.send(new WashingMessage(this, WATER_DRAIN));
                WashingMessage ackForWaterDRAIN2 = receive();
                System.out.println("washing program test got" + ackForWaterDRAIN2);
